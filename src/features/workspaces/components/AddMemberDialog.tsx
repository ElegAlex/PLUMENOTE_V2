 ...
 *
 * Modal dialog for adding a new member to a workspace.
...
export interface AddMemberDialogProps {
  ...
  workspaceId: string;
  /** List of existing member user IDs to exclude from search */
 ...
 * Handles adding member with toast notifications.
 *
 * @example
 * ```tsx
 * <AddMemberDialog
...
export function AddMemberDialog({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success(`${selectedUser.name || selectedUser.email} ajoute au workspace`);
      handleClose();
    } catch (error) {
      const message =
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            Recherchez un utilisateur et attribuez-lui un role dans le workspace.
          </DialogDescription>
        </DialogHeader>
